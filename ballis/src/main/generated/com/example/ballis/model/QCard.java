...
public class QCard extends EntityPathBase<Card> {
    ...
    private static final long serialVersionUID = -1912647479L;
    ...
    public final StringPath expiryMonth = createString("expiryMonth");

    public final StringPath expiryYear = createString("expiryYear");
